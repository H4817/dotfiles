 ...
 */
    ...
    function translatePage() {
        ...
        $("#available-flixel-themes-button").text(translate("options_tabs_title_flixel_bg"));
        $("#current-powered-video-text").text(translate("options_tabs_content_flixel_bg_notice"));
        $("#available-video-themes-button").text(translate("options_tabs_title_live_bg"));
        $("#available-image-themes-button").text(translate("options_tabs_title_static_bg"));
        $("#available-live-themes-button").text(translate("options_tabs_title_live_theme"));
        ...
        $(".options-settings-random-themes-enable-notice").text(translate("options_settings_random_themes_enable_notice"));
