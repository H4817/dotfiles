...
$(function() {
    ...
    //chrome.i18n.getAcceptLanguages(function(languages){
        ...
        $container.attr("data-description", translate("options_share_social_popup_title"));
        ...
        */
        ...
        $(document).on("click", "#share-button-fb, #share-button-fb-big", function(e) {
            e.preventDefault();
            window.open("http://www.facebook.com/sharer.php?m2w&" + fbQuery, "_blank", popupSettings);
        });

        $(document).on("click", "#share-button-twi, #share-button-twi-big", function(e) {
            e.preventDefault();
            window.open("http://twitter.com/intent/tweet?text=" + d + "&url=" + u, "_blank", popupSettings);
        });

        $(document).on("click", "#share-button-vk, #share-button-vk-big", function(e) {
            e.preventDefault();
            window.open("http://vk.com/share.php?url=" + u + "&title=" +  t + vkImage + "&description=" + d, "_blank", popupSettings);
        });

        $(document).on("click", "#share-button-odn, #share-button-odn-big", function(e) {
            e.preventDefault();
