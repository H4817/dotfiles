 ...
 */
     ...
     */
    function changeBackgroundImageFile(fs, data, defaultResponse) {//console.log("changeBackgroundImageFile(fs, data, defaultResponse)", data, defaultResponse);
    ...
    function changeBackgroundImageFileLoadComplete(url, data) {
        ...
        if(data.theme.downloadedByUser) BRW_sendMessage({command: "downloadImageByUserComplete"});
    }
...
/**
     ...
     * @param pageCallback Function
     */
    function downloadThemeImageFile(bg, theme, pageCallback) {//console.log("downloadThemeImageFile(bg, theme, pageCallback)", bg, theme, pageCallback);
        var url = bg.url;
        var resolution = bg.resolution;
        var fileName = bg.fileName;
