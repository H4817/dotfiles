...
var mailNotification = new Notification("Live Start Page", {
    ...
    icon : "chrome-extension://nolpdfnjkacmpnllkkkooooamdlbgmdo/img/icon/icon64.png"
});

mailNotification.onclick = function () {
  window.open("chrome-extension://nolpdfnjkacmpnllkkkooooamdlbgmdo/pages/newtab/newtab.html?meditation=start");      
};
...
mailNotification.onclose = function () {
    ...
    //window.open("chrome-extension://nolpdfnjkacmpnllkkkooooamdlbgmdo/pages/options/options.html?meditation=start");      
};
