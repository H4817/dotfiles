 ...
 */
    ...
    function getAvailableThemesList(callback, data) {
        ...
        //console.log("getAvailableThemesList", data);
                ...
                if(xhrAvailableContent.readyState == 4) {
                    if (this.status == 200) {
                        if(this.response) {
                            ...
                            if((sortType < 2 || sortType > 3) && response){
                            ...
                            if(!checkH264()){
                                for(var nm in {results:1, body:1, flixel_top:1}) if(response[nm]){
                                    ...
                                    if(len > 0) for(h = len; h--; h >= 0) if(response[nm][h].handmade == 1) response[nm].splice(h, 1);
                                }
                            }
     ...
     * @param mv Object
     */
    function printScreenOnServiceLoadComplete(mv) {//console.log("printScreenOnServiceLoadComplete", mv);
